...
const Showbooks = () => {
  ...
  return (
    <FormContainer title="Show books">
      <Row>
        ...
        {dropdownOptions["category"] 
          && dropdownOptions["category"].length > 0 && (
          <Col size="6">
            <Select
              label="category"
              ...
              value={loadedData?.category}
              disabled
            />
          </Col>
        )}
        {dropdownOptions["author"] 
          && dropdownOptions["author"].length > 0 && (
          <Col size="6">
            <Select
              label="author"
              placeholder="author"
              ...
              value={loadedData?.author}
              disabled
            />
          </Col>
        )}
        {dropdownOptions["editorial"] 
          && dropdownOptions["editorial"].length > 0 && (
          <Col size="6">
            <Select
              label="editorial"
