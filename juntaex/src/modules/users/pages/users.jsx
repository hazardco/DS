...
const schema = {"type":"object","properties":{"id":{"type":"integer","readOnly":true},"name":{"type":"string"},"surname":{"type":"string"},"email":{"type":"string","format":"email"},"birthdate":{"type":"string","format":"date"}},"required":["name","surname","email"]}
// Injected endpoints configuration for conditional actions
const endpoints = {"GET":{"operationId":"getUsers","summary":"Obtener lista de usuarios","responses":{"200":{"description":"Lista de usuarios","content":{"application/json":{"schema":{"type":"array","items":{"type":"object","properties":{"id":{"type":"integer","readOnly":true},"name":{"type":"string"},"surname":{"type":"string"},"email":{"type":"string","format":"email"},"birthdate":{"type":"string","format":"date"}},"required":["name","surname","email"]}}}}}}},"POST":{"operationId":"createUser","summary":"Crear un nuevo usuario","requestBody":{"required":true,"content":{"application/json":{"schema":{"type":"object","properties":{"id":{"type":"integer","readOnly":true},"name":{"type":"string"},"surname":{"type":"string"},"email":{"type":"string","format":"email"},"birthdate":{"type":"string","format":"date"}},"required":["name","surname","email"]}}}},"responses":{"201":{"description":"Usuario creado"}}}}
...
const users = () => {
  ...
  useEffect(() => {
    fetch(`${import.meta.env.VITE_SERVER_URL}/users`, { headers })
      .then((res) => res.json())
      .then((data) => {
  ...
  const handleDeleteConfirmed = () => {
    fetch(`${import.meta.env.VITE_SERVER_URL}/users/${deleteId}`, {
      method: 'DELETE',
      headers
    })
      .then((res) => {
        if (res.ok) {
          ...
          toast({
            ...
            content: 'The new users has been successfully deleted.',
  ...
  return (
    <div className="container-fluid p-4">
      ...
      <div className="d-flex justify-content-between align-items-center mb-4">
        <h1 className="h3 mb-0">users List</h1>
        {endpoints.POST && (
          <Button
            color="primary"
            iconLeft="plus"
