...
const openApiSchema = {"type":"object","properties":{"id":{"type":"integer","readOnly":true},"name":{"type":"string"},"surname":{"type":"string"},"email":{"type":"string","format":"email"},"birthdate":{"type":"string","format":"date"}},"required":["name","surname","email"]}
...
const Createusers = () => {
  ...
  const onSubmit = (values) => {
    ...
    fetch(`${import.meta.env.VITE_SERVER_URL}/users`, {
      ...
      .then(res => {
        ...
        toast({ status: 'success', title: 'Submission successful', content: 'The new users has been successfully created.', button: { label: 'Go to list', iconRight: 'arrow-right' }, duration: 2000 })
        navigate('/users')
      })
  ...
  return (
    <FormContainer title={`Create users`}>
