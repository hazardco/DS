...
const Editeditorials = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${import.meta.env.VITE_SERVER_URL}/editorials/${id}`, { headers })
      .then(res => res.json())
      .then(data => {
  ...
  const onSubmit = values => {
    ...
    fetch(`${import.meta.env.VITE_SERVER_URL}/editorials/${id}`, {
  ...
  return (
    <FormContainer title={`Edit editorials`}>
